...
\begin{abstract}
  ...
  increases---the chasm widens the chasm between fellow citizens, 
  and common ground erodes, washed
  ...
  extremists are more stubborn than centrists---however 
  behavioral studies on the subject may
  contain ubiquitous false detections of rising extremism, which I demonstrate
  in Study 3. 

  Finally in Study 4, I developed
...
% \input{Chapter2.tex}
% Needed to clean up Chapter 2 URLs which had the confusing, dreaded Mhttp
% in front of the URL.
\input{Chapter2Cleanup.tex}

\chapter{Stubborn extremism explains and predicts group polarization}

% \input{Chapter3.tex}
% Necessary because I am editing Chapter 3 to be a journal article.
\input{Chapter3Final.tex}
